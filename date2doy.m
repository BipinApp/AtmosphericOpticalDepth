function [doy,fraction,datePlot] = date2doy(inputDate)
...
% Modification : Bipin Raut

%Want inputs in rowwise format
%deal copies the zero matrix to variable doy and fraction
...
flagPlot = (nargout == 3);
if flagPlot
    datePlot(:) =  dateVector(:,1)-1 + fraction;
end 
